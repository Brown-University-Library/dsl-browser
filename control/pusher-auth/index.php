...
# PR: See http://pusher.com/docs/authenticating_users

#                     KEY                    SECRET                  ID
$pusher = new Pusher('d25ea4d1364af0aa79b0', '0e92888558063057dddf', 44743);
echo $pusher->socket_auth($_POST['channel_name'], $_POST['socket_id']);


# PR: PHP library from https://github.com/pusher/pusher-php-server/blob/master/lib/Pusher.php
